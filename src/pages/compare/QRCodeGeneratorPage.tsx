...
const data: ComparisonPageData = {
  ...
  table: {
    ...
    rows: [
      { feature: 'Free dynamic QR codes', values: { qrius: '15', qrcg: '1 (14-day trial)' } },
      { feature: 'Free plan scans', values: { qrius: '5,000/month', qrcg: 'No tracking' } },
      ...
      { feature: 'Paid plan starting at', values: { qrius: '$9/mo', qrcg: '~$8/mo (annual: ~$96 upfront)' } },
