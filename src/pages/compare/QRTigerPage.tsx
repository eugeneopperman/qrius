...
const data: ComparisonPageData = {
  ...
  table: {
    ...
    rows: [
      { feature: 'Free dynamic QR codes', values: { qrius: '5 (unlimited scans)', tiger: '3 (500 scans each)' } },
      { feature: 'Watermark on free', values: { qrius: false, tiger: true } },
      { feature: 'Edit design after creation', values: { qrius: true, tiger: false } },
      { feature: 'Paid plan starting at', values: { qrius: '$12/mo (50 codes)', tiger: '$7/mo (12 codes)' } },
  ...
  wins: {
    ...
    items: [
      ...
      { title: 'No watermarks, no scan limits on free.', description: "QR Tiger's free codes show a logo popup on scan and cap at 500 scans per code. Qrius free codes are clean and include unlimited scans." },
