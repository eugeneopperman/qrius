...
const data: ComparisonPageData = {
  ...
  table: {
    ...
    rows: [
      { feature: 'Free dynamic QR codes', values: { qrius: '15', bitly: '2/month' } },
      { feature: 'Free plan scans', values: { qrius: '5,000/month', bitly: 'Unlimited (with ads)' } },
      { feature: 'QR code types', values: { qrius: '9 (URL, vCard, WiFi, etc.)', bitly: '1 (URL only)' } },
      { feature: 'Paid plan starting at', values: { qrius: '$9/mo (250 codes)', bitly: '$10/mo (5 codes)' } },
      { feature: 'Comparable volume tier', values: { qrius: '$9/mo = 250 codes', bitly: '$29/mo = 10 codes' } },
  ...
  wins: {
    ...
    items: [
      ...
      { title: 'More codes for a fraction of the price.', description: "Bitly's Growth plan gives you 10 QR codes for $29/month. Qrius Pro gives you 250 for $9/month. That's not a rounding error — it's a fundamentally different value proposition." },
