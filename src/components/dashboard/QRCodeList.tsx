    ...
    return viewMode === 'list' ? (
      <div className="space-y-2">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="card-no-blur rounded-xl p-3 animate-pulse flex items-center gap-3">
            <div className="w-10 h-10 bg-black/5 dark:bg-white/5 rounded-lg flex-shrink-0" />
            <div className="flex-1 min-w-0">
              <div className="h-4 bg-black/5 dark:bg-white/5 rounded w-1/2 mb-1.5" />
